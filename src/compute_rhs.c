...
__global__ void rhs_init_kernel(double *u, double *rho_i, double *us, double*vs, double *ws, double *square, double *qs, double *speed, const int nx, const int ny, const int nz, const double c1c2)
{
	double aux, rho_inv;
...
__global__ void rhs_mult_dt_kernel(double *rhs, const int nx2, const int ny2, const int nz2, const double dt)
{
...
__global__ void rhs_x_kernel(double *u, double *rhs, double *rho_i, double *us, double *vs, double *ws, double *square, double *qs, const int nx2, const int ny2, const int nz2, const double dx1tx1, const double tx2, const double dx2tx1, const double xxcon2, const double con43, const double dx3tx1, const double dx4tx1, const double dx5tx1, const double xxcon3, const double xxcon4, const double xxcon5, const double c1, const double c2, const double dssp)
{
    double uijk, up1, um1;
    int m;
    int i = threadIdx.x + blockIdx.x * blockDim.x + 1;
...
__global__ void rhs_y_kernel(double *u, double *rhs, double *rho_i, double *us, double *vs, double *ws, double *square, double *qs, const int nx2, const int ny2, const int nz2, const double dy1ty1, const double ty2, const double dy2ty1, const double yycon2, const double con43, const double dy3ty1, const double dy4ty1, const double dy5ty1, const double yycon3, const double yycon4, const double yycon5, const double c1, const double c2, const double dssp)
{
    double vijk, vp1, vm1;
    int m;
    int i = threadIdx.x + blockIdx.x * blockDim.x + 1;
...
__global__ void rhs_z_kernel(double *u, double *rhs, double *rho_i, double *us, double *vs, double *ws, double *square, double *qs, const int nx2, const int ny2, const int nz2, const double dz1tz1, const double tz2, const double dz2tz1, const double zzcon2, const double con43, const double dz3tz1, const double dz4tz1, const double dz5tz1, const double zzcon3, const double zzcon4, const double zzcon5, const double c1, const double c2, const double dssp)
{
    double wijk, wp1, wm1;
    int m;
    int i = threadIdx.x + blockIdx.x * blockDim.x + 1;
...
void compute_rhs(int rhs_verify)
{
    ...
    SAFE_CALL(cudaMemcpy(g_rhs, g_forcing, size4, cudaMemcpyDeviceToDevice)); 
...
/*
	...
	*/
	...
	if(rhs_verify == 1) {
		...
		SAFE_CALL(cudaMemcpy(qs, g_qs, size3, cudaMemcpyDeviceToHost));  
		SAFE_CALL(cudaMemcpy(rho_i, g_rho_i, size3, cudaMemcpyDeviceToHost));  
		SAFE_CALL(cudaMemcpy(speed, g_speed, size3, cudaMemcpyDeviceToHost));  
		SAFE_CALL(cudaMemcpy(square, g_square, size3, cudaMemcpyDeviceToHost));  
